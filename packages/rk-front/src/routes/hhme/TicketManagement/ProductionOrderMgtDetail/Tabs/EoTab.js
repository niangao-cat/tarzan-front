...
export default class EoTab extends Component {
  ...
  render() {
    ...
    const columns = [
      {
        ...
        fixed: true,
        render: (val, record) => (
          <a className="action-link" onClick={() => jumpPage(record)}>
            {val}
          </a>
        ),
      ...
      },
      {
        ...
        ...this.getColumnSearchProps('eoIdentification'),
      },
      {
      ...
      },
      {
        ...
        width: 200,
        dataIndex: 'eoBomName',
        ...this.getColumnSearchProps('eoBomName'),
      },
      {
    ...
    return (
      <Table
        bordered
        pagination={{ ...eoPagination, pageSizeOptions: ['10', '50', '100', '200', '500', '1000'], defaultPageSize: '1000' }}
        rowKey="eoId"
        loading={loading}
        columns={columns}
        dataSource={eoList}
