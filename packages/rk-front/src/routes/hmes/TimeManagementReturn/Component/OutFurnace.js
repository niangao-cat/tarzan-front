 ...
 * @LastEditTime: 2020-12-24 20:40:39
...
export default class OutFurnace extends Component {
  ...
  render() {
    const { form, waitOutFurnace, addOutFurnaceLoading, handleContinueReworkLoading } = this.props;
    const columns = [
      {
        title: '序号',
        dataIndex: 'number',
        ...
        <Row>
          ...
          <Col span={6} style={{ textAlign: 'end' }}>
            <Button
              ...
              type="primary"
              disabled={waitOutFurnace.reworkFlag === 'N'}
