...
export async function fetchBaseInfo(params) {
  return request(`${Host}/v1/${tenantId}/hme-eo-job-sn-rework/in-site-scan`, {
    method: 'POST',
    body: params,
  });
}
...
export async function outSite(params) {
  return request(`${Host}/v1/${tenantId}/hme-eo-job-sn-rework/out-site-scan`, {
    method: 'POST',
    body: params,
  });
}
...
export function fetchFeedingRecord(params) {
  return request(`${Host}/v1/${tenantId}/hme-eo-job-sn-rework/release-back-query`, {
    method: 'GET',
    query: params,
  });
}
...
export function returnMaterial(params) {
  return request(`${Host}/v1/${tenantId}/hme-eo-job-sn-rework/release-back`, {
    method: 'POST',
    body: params,
  });
}
...
export function scanBarcode(params) {
  return request(`${Host}/v1/${tenantId}/hme-eo-job-sn-rework/release-scan`, {
    method: 'POST',
    body: params,
  });
}
...
export function deleteBarcode(params) {
  return request(`${Host}/v1/${tenantId}/hme-eo-job-sn-rework/delete-material`, {
    method: 'POST',
    body: params,
  });
}
...
export function feedMaterialList(params) {
  return request(`${Host}/v1/${tenantId}/hme-eo-job-sn-rework/release`, {
    method: 'POST',
    body: params,
  });
}

export function scrapMaterial(params) {
  return request(`${Host}/v1/${tenantId}/hme-eo-job-sn-rework/release-record-scrap`, {
    method: 'POST',
    body: params,
  });
}
...
export function fetchWorkCellMaterialList(params) {
  return request(`${Host}/v1/${tenantId}/hme-eo-job-sn-rework/wkc-bind-query`, {
    method: 'GET',
    query: params,
  });
}
...
export function printMaterialCode(params) {
  return request(`${Host}/v1/${tenantId}/hme-production-prints/production-multi-print`, {
    method: 'POST',
    body: params,
    responseType: 'blob',
  });
