...
import {
  ...
  fetchESopList,
} from '../../services/hhme/firstProcessPlatformService';


export default {
  namespace: 'firstProcessPlatform',
  state: {
    baseInfo: {},
    workCellInfo: {},
    siteInfo: {},
  ...
  effects: {
    ...
    *fetchVirtualNumList({ payload }, { call, put }) {
      const res = getResponse(yield call(fetchVirtualNumList, payload));
      if (res) {
        yield put({
          type: 'updateState',
          payload: {
    ...
    *autoCreateSnNum({ payload }, { call, put }) {
