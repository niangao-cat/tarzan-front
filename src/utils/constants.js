...
// 查询表单Row的水槽          ****专用于组织关系维护页面的Drawer
export const SEARCH_FORM_ROW_LAYOUT_FORDRAWER = {
  gutter: 4,
};
// 编辑表单Row的水槽
...
export const DRAWER_FORM_ITEM_LAYOUT_MAX = {
  labelCol: {
    span: 4,
  },
  wrapperCol: {
...
// 抽屉表单,展示型表单, 表单字段的布局  ****专用于组织关系维护页面的Drawer
export const DRAWER_FORM_ITEM_LAYOUT_FORDRAWER = {
  labelCol: {
    span: 9,
  },
  wrapperCol: {
