...
class ListTable extends Component {
  ...
  render() {
    ...
    const { loading, dataSource, pagination, onSearch, selectedRowKey, handleSelect, handleOnOpenBoard, handleOpenDrawerFlag, onBookShow } = this.props;
    const columns = [
      {
      ...
      },
      {
        ...
        render: (value, record) => {
          return (<a onClick={() => onBookShow(record.iqcHeaderId)}>{value}</a>);
        },
      },
      {
