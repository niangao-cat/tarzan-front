...
export async function getMaterialList(params) {
    return request(`${Host}/v1/${tenantId}/hme-cos-wire_bond/binding/material/query`, {
      method: 'GET',
      query: params,
    });
  }
...
export async function setOutBox(params) {
  return request(`${Host}/v1/${tenantId}/hme-cos-wire_bond/feeding/out`, {
    method: 'POST',
    body: params,
  });
}
...
// 投料
export async function feedingBox(params) {
  return request(`${Host}/v1/${tenantId}/hme-cos-wire_bond/feeding`, {
    method: 'POST',
    body: params,
  });
}
