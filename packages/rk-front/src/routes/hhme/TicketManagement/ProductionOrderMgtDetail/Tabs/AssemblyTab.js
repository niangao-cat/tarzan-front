...
export default class AssemblyTab extends Component {
  ...
  componentDidMount = () => {
    ...
    dispatch({
      ...
      payload: {
        ...{ workOrderId, page: { pageSize: 1000} },
      },
    });
  ...
  render() {
    ...
    const columns = [
      ...
      {
        title: intl.get(`${modelPrompt}.recoilFlag`).d('反冲标识'),
        dataIndex: 'recoilFlag',
        width: 100,
        align: 'left',
      },
      {
        title: intl.get(`${modelPrompt}.productionType`).d('物料生产类型'),
        dataIndex: 'productionType',
        width: 100,
        align: 'left',
      },
      {
        title: intl.get(`${modelPrompt}.upgradeFlag`).d('SN升级标志'),
      ...
      },
      {
        ...
        width: 150,
        align: 'left',
        ...this.getColumnSearchProps('assembleMethodDesc'),
      },
      {
        title: 'SAP总需求数量',
        dataIndex: 'totalComponentQty',
        width: 120,
        align: 'left',
      },
      {
      ...
      {
        title: intl.get(`${modelPrompt}.componentQty`).d('MES净需求数量'),
    ...
    return (
      <Fragment>
        <Table
          ...
          pagination={{ ...assemblyPagination, pageSizeOptions: ['10', '50', '100', '200', '500', '1000'], defaultPageSize: '1000' }}
