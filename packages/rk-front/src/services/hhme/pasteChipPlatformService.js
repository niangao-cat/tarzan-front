...
export async function scanBox(params) {
  return request(`${Host}/v1/${tenantId}/hme-cos-patch-pda/input/box/scan`, {
    method: 'POST',
    body: params,
  });
}
...
export async function queryBox(params) {
  return request(`${Host}/v1/${tenantId}/hme-cos-patch-pda/no/site/out/query`, {
    method: 'POST',
    body: params,
  });
}
...
export async function setOutBox(params) {
  return request(`${Host}/v1/${tenantId}/hme-cos-patch-pda/site/in/confirm`, {
    method: 'POST',
    body: params,
  });
}
...
export async function reCall(params) {
  return request(`${Host}/v1/${tenantId}/hme-cos-patch-pda/materiallot/recall`, {
    method: 'POST',
    body: params,
  });
}
...
export function recallPrint(params) {
  return request(`${Host}/v1/${tenantId}/hme-cos-patch-pda/print/recall`, {
    method: 'POST',
    body: params,
  });
}