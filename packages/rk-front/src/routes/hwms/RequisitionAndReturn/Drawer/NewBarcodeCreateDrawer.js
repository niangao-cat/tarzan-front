...
@connect(({ requisitionAndReturn, loading }) => ({
  ...
  createLoading: loading.effects['requisitionAndReturn/deliverCreateBarcodeData'],
}))
export default class NewBarcodeCreateDrawer extends Component {
  ...
  render() {
    ...
    return (
      ...
      >
        <Spin spinning={createLoading || false}>
          <Form>
            <Row>
              <Col span={12}>
                <Form.Item {...DRAWER_FORM_ITEM_LAYOUT} label="单号">
