 ...
 * @LastEditTime: 2021-02-23 10:03:29
...
export default class InFurnace extends Component {
  ...
  render() {
    const { form, waitInFurnace = {} } = this.props;
            ...
            <Col span={24}>
              <Form.Item>
                {form.getFieldDecorator('snNum', {})(
                  <Input id="infurnaceCode" placeholder="请扫描条码" style={{ height: '45px' }} />
                )}
              </Form.Item>
            </Col>
            <Col span={0} style={{ textAlign: 'end' }}>
              <Form.Item>
                <Button
                  style={{
                    display: 'none',
