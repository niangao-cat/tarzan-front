 ...
 * @reactProps {Object} objectType - 数据源
 * @reactProps {Object} form - 表单对象
 * @return React.element
 */
@connect(({ objectType, loading }) => ({
  objectType,
  fetchMessageLoading: loading.effects['objectType/fetchObjectTypeList'],
}))
      ...
      <Form className={SEARCH_FORM_CLASSNAME}>
        <Row {...SEARCH_FORM_ROW_LAYOUT}>
          <Col {...FORM_COL_4_LAYOUT}>
            ...
            >
              {getFieldDecorator('objectTypeCode')(<Input />)}
            </Form.Item>
          </Col>
          <Col {...FORM_COL_4_LAYOUT}>
            <Form.Item
          ...
          <Col {...FORM_COL_4_LAYOUT} className={SEARCH_COL_CLASSNAME}>
            <FormItem>
              ...
              <Button type="primary" htmlType="submit" onClick={this.queryValue}>
                {intl.get('tarzan.event.objectType.button.search').d('查询')}
              </Button>
            </FormItem>
          </Col>
        </Row>
