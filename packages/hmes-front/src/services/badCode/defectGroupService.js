...
export async function fetchDefectCodeList(params) {
  ...
  return request(`${Host}/v1/${tenantId}/mt-nc-group/list/ui`, {
    method: 'GET',
    query: param,
  });
}
...
export async function saveDefectCodeList(params) {
  return request(`${Host}/v1/${tenantId}/mt-nc-group/save/ui`, {
    method: 'POST',
    body: params,
  });
}
...
export async function fetchSingleCode(params) {
  return request(`${Host}/v1/${tenantId}/mt-nc-group/detail/ui`, {
    method: 'GET',
    query: params,
  });
}
