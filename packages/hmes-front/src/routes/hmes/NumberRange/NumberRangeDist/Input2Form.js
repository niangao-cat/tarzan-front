...
export default class Input2Form extends Component {
  constructor(props) {
    super(props);
    props.onRef(this);
    this.state = {
  ...
  onRadioChange = e => {
    ...
    const {
      ...
      setCurrentRule,
      changeRuleId,
      numberRange: { inputBox2List = {} },
    } = this.props;
    const { numrangeRuleId } = inputBox2List;
    setCurrentRule(2, e.target.value);
    changeRuleId(e.target.value, 1);
    dispatch({
      type: 'numberRange/updateState',
      payload: {
        inputBox2List: { numrangeRuleId },
      },
    });
    if (e.target.value === '1') {
      form.resetFields([
  ...
  onInputChange(rule, value, exampleValue, format) {
    ...
    setCurrentValue(2, value, exampleValue, format);
    if (rule === '5') {
              ...
              <Col {...FORM_COL_3_LAYOUT}>
                ...
                >
                  {getFieldDecorator('numLevel', {
                    initialValue: numLevel || 'OVERALL_SERIAL_NUM',
                    rules: [
                      {
                        required: true,
                        message: intl.get('hzero.common.validation.notNull', {
              ...
              <Col {...FORM_COL_3_LAYOUT}>
                ...
                >
                  {getFieldDecorator('numConnectInputBox', {
                    ...
                    <Checkbox.Group style={{ width: '450px' }} disabled={isOverAll}>
                      <Checkbox
                        value={1}
              ...
              <Col {...FORM_COL_3_LAYOUT}>
                ...
                >
                  {getFieldDecorator('numAlertGroup', {
                    itialValue: numAlertType + numAlert,
                    rules: [
                      {
                        required: true,
                        message: intl.get('hzero.common.validation.notNull', {
