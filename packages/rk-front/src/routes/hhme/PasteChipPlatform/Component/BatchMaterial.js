                ...
                >
                  ...
                  >
                    <Tooltip title={e.materialName}>
                      ...
                      >
                        {e.materialName}
                        <span style={{float: 'right', borderLeftStyle: 'solid', borderLeftColor: '#45acf1', borderLeftWidth: '1px', width: '40px', textAlign: 'center'}}>&nbsp;&nbsp;{e.qty}&nbsp;&nbsp;</span>
                      </div>
                    </Tooltip>
                    <Tooltip title={e.materialLotCode}>
                      ...
                      >
                        {e.materialId ? e.materialLotCode : (
                          <Input onPressEnter={event => this.handleBindingEq(event, e)} />
                        )}
                        <span style={{float: 'right', borderLeftStyle: 'solid', borderLeftColor: '#45acf1', borderLeftWidth: '1px', width: '40px', textAlign: 'center'}}>&nbsp;&nbsp;{e.uomCode}&nbsp;&nbsp;</span>
                      </div>
                    </Tooltip>
                  </div>
                </div>
