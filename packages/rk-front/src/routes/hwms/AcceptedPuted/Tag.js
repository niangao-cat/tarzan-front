      ...
      <div className={styles['board-tag']}>
        ...
        <Row style={{ padding: '6px 6px' }}>
          <Col span={13}>
            ...
            <span style={{ marginLeft: '4px' }}>待上架天数&gt;3</span>
          </Col>
          <Col span={11}>
        ...
        <Row style={{ padding: '6px 6px' }}>
          <Col span={13}>
            ...
            <span style={{ marginLeft: '4px' }}>待上架天数1~3</span>
          </Col>
          <Col span={11}>
            <img src={tag5} alt="" style={{ marginTop: '-2px' }} />
            <span style={{ marginLeft: '4px' }}>特采物料</span>
          </Col>
        </Row>
        <Row style={{ padding: '6px 6px' }}>
          <Col span={13}>
            <img src={tag2} alt="" style={{ marginTop: '-2px' }} />
            <span style={{ marginLeft: '4px' }}>待上架天数&lt;1</span>
          </Col>
          <Col span={11}>
