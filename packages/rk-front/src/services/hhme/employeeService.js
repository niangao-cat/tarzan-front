...
export async function fetchQualityList(params) {
  const param = parseParameters(params);
  return request(`${mes}/v1/${param.tenantId}/hme-employee-assigns`, {
    method: 'GET',
    query: param,
  });
}
...
export async function saveQuality(params) {
  return request(`${mes}/v1/${params.tenantId}/hme-employee-assigns/createOrUpdate`, {
    method: 'POST',
    body: params.arr,
  });
}
...
// 删除人员资质数据
export async function onDeleteQuality(params) {
  return request(`${mes}/v1/${params.tenantId}/hme-employee-assigns`, {
    method: 'DELETE',
    body: params.arr,
  });
}