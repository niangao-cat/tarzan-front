      ...
      <div className={styles['test-content']}>
        ...
        <div className={styles['calculator-content']}>
          ...
          <Row>
            ...
            <Col span={6}>
              <div className={styles['calculator-btn']}>
                <Button disabled={pqcInfo.inspectionStatus !== 'NEW' || isEmpty(resultRecord) || testRecord.standardType !== 'VALUE'} icon="enter" style={{ height: '74px' }} onClick={() => this.handleClickEnter()} />
              </div>
            </Col>
          </Row>
          <Row>
