...
export default class BasicTab extends PureComponent {
  ...
  componentDidMount() {
    const { form, relationMaintainDrawer } = this.props;
    const { displayList = {} } = relationMaintainDrawer;
  ...
  setSizeUomDesc(_, record) {
    this.props.form.setFieldsValue({
      sizeUomDesc: record.uomTypeDesc,
   ...
   */
  render() {
    const { form, locatorId, editFlag, relationMaintainDrawer } = this.props;
    const { displayList = {} } = relationMaintainDrawer;
    const {
      maxWeight,
      weightUomCode,
