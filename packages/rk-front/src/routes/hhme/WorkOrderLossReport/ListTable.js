...
export default class HeadTable extends React.Component {
  ...
  render() {
    ...
    const columns = [
      ...
      {
        title: '联产品损失',
        dataIndex: 'coproductScrappedQuantity',
        align: 'center',
        width: 80,
        onCell: this.handleGetBomComponentClassName,
      },
      {
        title: '计划内报损合计',
        dataIndex: 'plannedScrappedSumQuantity',
        align: 'center',
        width: 100,
      ...
      {
        title: '计划外报损合计',
        dataIndex: 'unplannedScrappedSumQuantity',
        align: 'center',
        width: 100,
        onCell: this.handleGetSumClassName,
      },
      ...
      {
        title: '实际损耗率',
        dataIndex: 'actualAttritionChance',
        align: 'center',
        width: 100,
        onCell: this.handleGetSumClassName,
      },
