            ...
            <Col span={12}>
              <Form.Item labelCol={{ span: 4 }} wrapperCol={{ span: 10 }} label='条码'>
                {getFieldDecorator('materialLotCode', {
                  ...
                  <Input suffix={<Icon type="enter" />} disabled={enableDo} onKeyDown={this.onEnterDownCode} />
                )}
              </Form.Item>
            </Col>
            <Col span={12} style={{ textAlign: 'end' }}>
              <Form.Item>
                <Button disabled={enableDo} onClick={this.handleClearData}>
                 清空
                </Button>
              </Form.Item>
            </Col>
