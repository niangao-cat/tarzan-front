...
export default class FilterForm extends React.Component {
  ...
  // 渲染
  render() {
    const { form, barcodeStatusList, qualityStatusList } = this.props;
        ...
        <Row {...SEARCH_FORM_ROW_LAYOUT} style={{ display: expandForm ? '' : 'none' }}>
          <Col {...FORM_COL_4_LAYOUT}>
            <Form.Item
              ...
              label='入库时间从'
            >
              {getFieldDecorator('receiptDateFrom')(
                <DatePicker
                  placeholder=""
                  style={{ width: '100%' }}
                  showTime
          ...
          <Col {...FORM_COL_4_LAYOUT}>
            <Form.Item
              ...
              label='入库时间至'
            >
              {getFieldDecorator('receiptDateTo')(
                <DatePicker
                  placeholder=""
                  showTime
                  format={getDateTimeFormat()}
          ...
          <Col {...FORM_COL_4_LAYOUT}>
            ...
            >
              {getFieldDecorator('locator')(
                <Lov code="WMS.MTL_LOCATOR" queryParams={{ tenantId: getCurrentOrganizationId() }} />
              )}
            </Form.Item>
          </Col>
        </Row>
