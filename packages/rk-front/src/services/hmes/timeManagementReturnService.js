...
export async function fetchListTimeSn(params) {
  return request(`${Host}/v1/${organizationId}/hme-eo-job-sn-time-rework/list-for-time-sn/page`, {
    method: 'GET',
    query: params,
  });
}
...
export async function scanningInFurnaceCode(params) {
  return request(`${Host}/v1/${organizationId}/hme-eo-job-sn-time-rework/time-sn-scan`, {
    method: 'GET',
    query: params,
  });
}
...
export async function addInFurnace(params) {
  return request(`${Host}/v1/${organizationId}/hme-eo-job-sn-time-rework/in-site-scan`, {
    method: 'POST',
    body: params,
  });
}
...
export async function addOutFurnace(params) {
  return request(`${Host}/v1/${organizationId}/hme-eo-job-sn-time-rework/out-site-scan`, {
    method: 'POST',
    body: params,
  });
}
...
export async function handleContinueRework(params) {
  return request(`${Host}/v1/${organizationId}/hme-eo-job-sn-time-rework/continue-rework`, {
    method: 'POST',
    body: params,
  });
}
