...
export default class DataForm extends Component {
   ...
   */
  render() {
    const { employeeStatus = [], form } = this.props;
        ...
        <Row gutter={48}>
          <Col {...FORM_COL_3_LAYOUT}>
            ...
            >
              ...
              })(<Input trim typeCase="upper" inputChinese={false} disabled />)}
            </Form.Item>
          </Col>
          <Col {...FORM_COL_3_LAYOUT}>
            <Form.Item
            ...
            >
              {getFieldDecorator('status', {
                ...
                <Select className={styles['full-width']} allowClear disabled>
            ...
            >
              {getFieldDecorator('entryDate', {
                initialValue: employeeInfo.entryDate
                  ...
                  : undefined,
              })(<DatePicker disabled placeholder="" style={{ width: '100%' }} format={getDateFormat()} />)}
            </Form.Item>
          </Col>
        </Row>
      </Form>
