...
export function scanBarcode(params) {
  return request(`${Host}/v1/${tenantId}/hme-visual-inspection/material-lot-scan`, {
    method: 'POST',
    body: params,
  });
}

export function scanContainerCode(params) {
  return request(`${Host}/v1/${tenantId}/hme-visual-inspection/container-scan/${params.containerCode}`, {
    method: 'GET',
  });
}

export function finish(params) {
  return request(`${Host}/v1/${tenantId}/hme-visual-inspection/complete`, {
    method: 'POST',
    body: params,
  });
}
...
export function fetchMaterialInfo(params) {
  return request(`${Host}/v1/${tenantId}/hme-visual-inspection/material-lot-query`, {
    method: 'GET',
    query: params,
  });
}

export function cancelInSite(params) {
  return request(`${Host}/v1/${tenantId}/hme-visual-inspection/site-in-cancel`, {
    method: 'POST',
    body: params,
  });
}
