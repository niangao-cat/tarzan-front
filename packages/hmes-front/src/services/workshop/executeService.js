...
export async function print(params) {
  return request(`${Host}/v1/${tenantId}/hme-mt-eo/print/${params.type}`, {
    method: 'POST',
    body: params.hmeEoVO3List,
    responseType: 'blob',
  });
}

// 打印条码
export async function printSn(params) {
  return request(`${Host}/v1/${tenantId}/hme-mt-eo/print/${params.type}`, {
    method: 'POST',
    body: params.hmeEoVO3List,
    responseType: 'blob',
...
export async function validate(params) {
  return request(`${Host}/v1/${tenantId}/hme-mt-eo/print-check`, {
    method: 'POST',
    body: params.hmeEoVO3List,
  });
}
...
export function fetchNameplateList(params) {
  return request(`${Host}/v1/${tenantId}/hme-production-prints/internal-code-query`, {
    method: 'POST',
    body: params,
  });
}

export function printNameplateList(params) {
  return request(`${Host}/v1/${tenantId}/hme-production-prints/eo-nameplate-print`, {
    method: 'POST',
    body: params,
    responseType: 'blob',
  });
