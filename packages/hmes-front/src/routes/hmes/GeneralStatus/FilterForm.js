...
@connect(({ generalStatus, loading }) => ({
  ...
  fetchMessageLoading: loading.effects['generalStatus/fetchStatusList'],
}))
      ...
      <Form className={SEARCH_FORM_CLASSNAME}>
        <Row {...SEARCH_FORM_ROW_LAYOUT}>
          <Col {...FORM_COL_4_LAYOUT}>
            ...
            >
              {getFieldDecorator('statusGroup')(<Input />)}
            </Form.Item>
          </Col>
          <Col {...FORM_COL_4_LAYOUT}>
            <Form.Item
            ...
            >
              {getFieldDecorator('statusCode')(<Input />)}
            </Form.Item>
          </Col>
          <Col {...FORM_COL_4_LAYOUT}>
            <Form.Item
              {...SEARCH_FORM_ITEM_LAYOUT}
              label={intl.get(`${modelPrompt}.module`).d('服务包')}
            >
          ...
          <Col {...FORM_COL_4_LAYOUT} className={SEARCH_COL_CLASSNAME}>
            <FormItem>
              ...
              <Button type="primary" htmlType="submit" onClick={this.queryValue}>
                {intl.get('tarzan.hmes.status.button.search').d('查询')}
              </Button>
            </FormItem>
          </Col>
        </Row>
