...
import {
  ...
  saveHeaderList,
  saveLineList,
} from '../../services/hhme/polarizationDivergenceYieldService';

export default {
  namespace: 'polarizationDivergenceYield',
  state: {
    headList: [],
    headPagination: {},
    lineList: [],
  ...
  effects: {
    *init(_, { call, put }) {
      const res = yield call(queryMapIdpValue, {
        testObjectList: 'HME.COS_TEST_OBJECT',
        testTypeList: 'HME.TEST_TYPE',
      });
      yield put({
        type: 'updateState',
        payload: {
