...
export function fetchBaseInfo(params) {
  return request(`${Host}/v1/${tenantId}/hme-eo-job-pump-combs/in-site-scan`, {
    method: 'POST',
    body: params,
  });
}
...
export async function outSite(params) {
  return request(`${Host}/v1/${tenantId}/hme-eo-job-pump-combs/out-site-scan`, {
    method: 'POST',
    body: params,
  });
}
...
export async function autoCreateSnNum(params) {
  return request(`${Host}/v1/${tenantId}/hme-eo-job-pump-combs/scan-wo`, {
    method: 'GET',
    query: params,
  });
}
...
export function scanBarcode(params) {
  return request(`${Host}/v1/${tenantId}/hme-eo-job-pump-combs/release-scan`, {
    method: 'POST',
    body: params,
  });
}
...
export function deleteBarcode(params) {
  return request(`${Host}/v1/${tenantId}/hme-eo-job-pump-combs/delete-material`, {
    method: 'POST',
    body: params,
  });
}
...
export function returnSnMaterial(params) {
  return request(`${Host}/v1/${tenantId}/hme-eo-job-pump-combs/release-back`, {
    method: 'POST',
    body: params,
  });
}